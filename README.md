...
> [!IMPORTANT]
> The XSOverlay beta branch has official OSC chatbox support now, making this plugin defunct. You can still use it on the stable release for now
