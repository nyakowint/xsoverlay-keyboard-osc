Version 1.3.0 changes how Keyboard OSC settings are added to the settings page & how patches are applied internally.
...
A quick-install has also been added to the [install script](https://github.com/nyakowint/xsoverlay-keyboard-osc#install)!